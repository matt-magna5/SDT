...
```powershell
iwr https://github.com/trophyscar-bit/sdt/archive/refs/tags/v2.4.zip -OutFile C:\Temp\sdt.zip; Expand-Archive C:\Temp\sdt.zip C:\Temp -Force; cd C:\Temp\sdt-2.4
```
